...
namespace TBQuestGameRH.PresentationLayer
{
    public partial class GameSessionViewModel : ObservableObject
    {
        ...
        private void OnPlayerPickUp(GameItemQuantity gameItem)
        {
            _player.Level += gameItem.Level;
        }

        private void OnPlayerPutDown(GameItemQuantity gameItem)
        {
        }
        ...
        private void ProcessWeaponUse(Weapon weapon)
        {
            ...
            //_player.Level += drug.LevelChange;
            //_player.RemoveGameItemQuantityFromInventory(_currentGameItem);
        }

        private void ProcessDrugUse(Drug drug)
        {
            _player.HP += drug.HPChange;
            _player.Level += drug.LevelChange;
            _player.RemoveGameItemQuantityFromInventory(_currentGameItem);
        ...
        {
            _player.BattleMode = BattleModeName.RunAway;
            Battle();
        }
        ...
        private void Battle()
        {
            if (_currentNpc is IBattle)
            {
                ...
                {
                    battleInformation = $"{_currentNpc.Name} has no weapon!" + Environment.NewLine;
                }
                ...
                {
                    battleInformation += $"{_currentNpc.Name} killed you. The worms have closed in.";
                    OnPlayerDies("");
                }
            ...
            {
                CurrentLocationInformation = "You people voted for Hubert Humphrey, and you killed Jesus!";
            }
        ...
        private int CalculatePlayerHitPoints()
        {
            ...
            switch (_player.BattleMode)
            {
                ...
                case BattleModeName.Defend:
                    ...
                    break;
                case BattleModeName.RunAway:
                    playerHitPoints = _player.RunAway();
                    break;
            }
        ...
        private int CalculateNpcHitPoints(IBattle battleNpc)
        {
            ...
            switch (NpcBattleResponse())
            {
                ...
                case BattleModeName.Defend:
                    ...
                    break;
                case BattleModeName.RunAway:
                    battleNpcHitPoints = battleNpc.RunAway();
                    break;
            }
        ...
        {
            BattleModeName npcBattleResponse = BattleModeName.RunAway;
            ...
            switch (DieRoll(3))
            {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    npcBattleResponse = BattleModeName.RunAway;
                    break;
            }
